...
function Header() {
    ...
    return (
        ...
        <header className="w-full p-4 flex items-center justify-between shadow-lg z-10 border-b
                         bg-light-surface dark:bg-gray-800 classic:bg-deep-night-blue
                         border-gray-200 dark:border-gray-700 classic:border-gray-700 transition-colors duration-300">
            ...
            <div className="flex items-center space-x-6">
                {/* 3. Añadimos el selector de tema al header */}
                <ThemeSwitcher />

                {/* Muestra el nombre del usuario si está logueado */}
                {user && (
                    <span className="text-lg text-light-text dark:text-neutral-light classic:text-neutral-light font-medium">
